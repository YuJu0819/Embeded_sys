...
#include "ble/services/Meg.h"
#include "pretty_printer.h"
#include "mbed-trace/mbed_trace.h"
#include "../BSP_B-L475E-IOT01/Drivers/BSP/B-L475E-IOT01/stm32l475e_iot01_magneto.h"
...
public:
    ...
    HeartrateDemo(BLE &ble, events::EventQueue &event_queue) :
        ...
        _magneto_uuid(GattService::UUID_BATTERY_SERVICE),
...
private:
    ...
    void update_sensor_value()
    {
        ...
        _magneto_service.updateMagnetoValues(pDataXYZ[0], pDataXYZ[1], pDataXYZ[2]);
    }
